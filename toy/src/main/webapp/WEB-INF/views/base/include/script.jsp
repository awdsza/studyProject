...
<!-- Bootstrap core JavaScript
	...
	<script src="${pageContext.request.contextPath}/resources/base/js/vendor.js"></script>
	<script src="${pageContext.request.contextPath}/resources/bootstrap/js/bootstrap.js"></script>
	<script src="${pageContext.request.contextPath}/resources/base/js/vue.js"></script>
	<script src="${pageContext.request.contextPath}/resources/base/js/axios.min.js"></script>
