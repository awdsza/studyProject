...
<body>
	<div class="container">
      <form class="form-signin" name="accountFrm" action="${pageContext.request.contextPath}/action/user/insert" method="post">
        ...
        <input type="text" class="form-control" required="" name="user_id" id="user_id" placeholder="ID">
        <label for="user_pw" class="sr-only">비밀번호</label>
        <input type="password" class="form-control"  name="user_pw" id="user_pw" required="" placeholder="비밀번호">
        <label for="user_email" class="sr-only">이메일</label>
        <input type="email" class="form-control"  name="user_email" id="user_email" required="" autofocus="" placeholder="이메일">
        <label for="user_name" class="sr-only">이름</label>
        <input type="text" class="form-control"  name="user_name" id="user_name" required="" autofocus="" placeholder="이름">
        <label for="user_phone" class="sr-only">번호</label>
        <input type="text" class="form-control"  name="user_phone" id="user_phone" required="" autofocus="" placeholder="번호">
        <label for="user_addr" class="sr-only">주소</label>
        <input type="text" class="form-control"  name="user_addr" id="user_addr" required="" autofocus="" placeholder="주소">
